                    ...
                    <Button intent="icon">
                      <div className="flex flex-row gap-2 items-center justify-center">
                        ...
                        <ModeToggle />
                          <Avatar>
                            <AvatarImage
                              src={wordpressPluginBoilerplateFrontend.userInfo.avatar}
                              alt={wordpressPluginBoilerplateFrontend.userInfo.username}
                            />
                            <AvatarFallback>CN</AvatarFallback>
                          </Avatar>
                        </div>
                        <div className="text-neutral-600 text-xs font-medium leading-none">
                          {wordpressPluginBoilerplateFrontend.userInfo.username}
                        </div>
                        <div className="text-neutral-600 text-xs font-medium leading-none">
                          <Icons.DownIcon />
                        </div>
