...
const fetchData = async () => {
  try {
    const response = await fetch(wordpressPluginBoilerplateFrontend.apiUrl + "myplugin/v1/accounts/get");
    if (!response.ok) {
...
const deleteAccount = async () => {
  try {
    const response = await fetch(
      wordpressPluginBoilerplateFrontend.apiUrl + "myplugin/v1/accounts/delete",
    );
    if (!response.ok) {
      throw new Error("Network response was not ok");
    }
